...
#include "ExcelImporterInteractiveTool.generated.h"
...
public:
	UExcelImporterInteractiveToolProperties();
...
/**
 * UExcelImporterInteractiveTool is an example Tool that allows the user to measure the 
