...
#include "ExcelImporterEditorMode.generated.h"
 ...
 */
UCLASS()
class UExcelImporterEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_ExcelImporterEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UExcelImporterEditorMode();
	virtual ~UExcelImporterEditorMode();
